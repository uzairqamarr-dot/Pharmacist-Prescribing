...
["lipid","The three protocols have three different 'not at target' referral intervals. Give all three.","Hypertension: 4–6 weeks on two maximum-dose agents. Blood glucose: no fixed interval &mdash; the protocol says <i>&ldquo;within appropriate timeframe&rdquo;</i> on two optimal-dose agents. (The 3 months in that protocol is the HbA1c review point and the &ge;0.5% rule, not the referral trigger.) Lipids: 6 months. Easy to conflate — exactly the detail a written paper targets."],
...
["bgl","A patient on an SGLT2 inhibitor is unwell. What single test must be done regardless of the glucose reading, and what are the thresholds?","Blood ketones. A normal glucose does NOT exclude euglycaemic DKA on an SGLT2 inhibitor. <b>Blood ketones (NSW ACI):</b> 0.6 mmol/L or lower is <b>normal</b>. <b>≥1.0</b> — or any level if they are unwell with nausea, vomiting or abdominal pain, with or without hyperglycaemia — increase monitoring and test for acidosis. <b>&gt;1.5</b> — urgent clinical review. Go straight to hospital for severe/worsening hyperglycaemia, persistent vomiting &gt;4 h, high fever, abdominal pain, severe headache, drowsiness, marked ketosis or recurrent hypoglycaemia."],
...
["wt","A concrete number to motivate a patient who feels 5% weight loss sounds trivial?","A 1% body weight reduction lowers systolic BP by about 1 mmHg. Also: weight loss ≥10% may allow reduction or cessation of glucose-lowering medication; even &gt;5% improves control and can produce remission, <b>especially within 1&ndash;2 years of diagnosis</b> &mdash; that is the QLD protocol's window. (6 years is DiRECT's enrolment window, not the remission window.)"],
...
var LINKS = [
  {id:"protocols", name:"THE PROTOCOLS — what governs what you may do", blurb:"The seven Queensland documents. These decide eligibility, exclusions, what you may prescribe and when you must refer. Everything else on this page tells you what is clinically appropriate; only these tell you what is permitted. Verified against the Queensland Health protocols page, 14 Sep 2026.", items:[
    ...
    {n:"Improved ASTHMA Symptom Control Program", u:"https://www.health.qld.gov.au/__data/assets/pdf_file/0012/1304400/asthma-protocol.pdf", w:"Eligibility, alarm signs, what you may prescribe, action plans.", t:"Governs practice"},
    {n:"COPD Monitoring Program", u:"https://www.health.qld.gov.au/__data/assets/pdf_file/0013/1304401/copd-protocol.pdf", w:"Case finding, severity assessment, spirometry, prednisolone rules. Steps A–H.", t:"Governs practice"},
    {n:"Management for OVERWEIGHT AND OBESITY", u:"https://www.health.qld.gov.au/__data/assets/pdf_file/0020/1304390/overweight-obesity-management-guideline.pdf", w:"Refer-when and treat-and-concurrently-refer lists, Management Plan A and B, orlistat criteria.", t:"Governs practice"},
    {n:"SMOKING CESSATION clinical practice guideline", u:"https://www.health.qld.gov.au/__data/assets/pdf_file/0023/1304249/smoking-cessation-guideline.pdf", w:"Week 5 topic. The guideline the protocols cross-refer to for smoking and vaping cessation.", t:"Governs practice"},
    {n:"Summary of changes to the pilot clinical protocols", u:"https://www.health.qld.gov.au/__data/assets/pdf_file/0019/1492210/summary-of-changes-pilot-clinical-protocols.pdf", w:"What changed in April 2026. Check this before answering any eligibility question — several criteria were revised.", t:"Governs practice"},
    {n:"All pilot clinical protocols (index page)", u:"https://www.health.qld.gov.au/clinical-practice/guidelines-procedures/community-pharmacy-pilots/resources/clinical/protocols", w:"The source page, in case a protocol is revised again.", t:"Governs practice"},
    {n:"Pilot chronic conditions handbook", u:"https://www.health.qld.gov.au/__data/assets/pdf_file/0012/1451001/chronic-conditions-pilot-handbook.pdf", w:"How the pilot operates around the protocols — service model, documentation, notification.", t:"Governs practice"}
  ]},
{id:"cvdrisk", name:"Absolute CVD risk", blurb:"Risk band decides the treatment threshold, so this comes before any drug decision. Remember the two frameworks use different band labels for the same numbers.", items:[
  ...
  {id:"bgl", name:"Blood glucose and type 2 diabetes", blurb:"The ADS algorithm is the escalation map. The QLD protocol is the scope boundary. They answer different questions — do not substitute one for the other.", items:[
    {n:"NDSS — Managing Hypoglycaemia fact sheet", u:"https://www.ndss.com.au/", w:"Patient-facing hypoglycaemia education. The course names this specifically for patients on insulin or sulfonylureas.", t:"AU guideline"},
    {n:"Diabetes Australia — glucose self-monitoring position statement", u:"https://www.diabetesaustralia.com.au/health-professional-guidelines/", w:"Glucose Self-Monitoring in Adults with Type 1 or Type 2 Diabetes. The detailed guidance behind SMBG advice.", t:"AU guideline"},
    {n:"AUSDRISK — Australian type 2 diabetes risk assessment tool", u:"https://www.health.gov.au/resources/apps-and-tools/the-australian-type-2-diabetes-risk-assessment-tool-ausdrisk/tool", w:"Run this alongside AusCVDRisk for any patient without a diabetes or pre-diabetes diagnosis. Two tools, two different risks.", t:"Tool"},
  ...
  {id:"lifestyle", name:"Lifestyle and behaviour change", blurb:"All patients get non-pharmacological advice, even those not prescribed anything. These are the sources the course names for each modifiable risk factor.", items:[
    {n:"RACGP SNAP — applying the 5As to each risk factor", u:"https://www.racgp.org.au/clinical-resources/clinical-guidelines/key-racgp-guidelines/view-all-racgp-guidelines/snap/applying-the-5as-to-each-risk-factor", w:"The 5As worked through for smoking, overweight and obesity, nutrition, alcohol and physical activity. The practical how-to for behavioural risk modification.", t:"AU guideline"},
    {n:"Australian Dietary Guidelines", u:"https://www.eatforhealth.gov.au/guidelines", w:"The source the course names for all nutritional recommendations and advice. Five food groups, portions, what to limit.", t:"AU guideline"},
    {n:"Physical activity and exercise guidelines for all Australians", u:"https://www.health.gov.au/topics/physical-activity/24-hour-movement-guidelines-for-all-australians", w:"Recommendations by age group. Consider the patient's ability to exercise safely, including mobility and flexibility, before advising.", t:"AU guideline"},
    {n:"Australian guidelines to reduce health risks from drinking alcohol", u:"https://www.nhmrc.gov.au/about-us/publications/australian-guidelines-reduce-health-risks-drinking-alcohol", w:"NHMRC. The source for alcohol advice — note alcohol has a mixed effect on the lipid profile, not a simple one.", t:"AU guideline"},
    {n:"Lung Foundation — clinical tools and training", u:"https://lungfoundation.com.au/health-professionals/clinical-tools-and-training/", w:"Smoking cessation resources alongside the COPD tools.", t:"AU guideline"}
  ]},
  ...
  {id:"fh", name:"Familial hypercholesterolaemia and Lp(a)", blurb:"FH affects about 1 in 250 people and only around 10% of Australians who have it are diagnosed. Signs of FH are on the Week 3 general-observation list, and FH above the cholesterol thresholds is a Program exclusion.", items:[
    {n:"Statin deprescribing algorithm (deprescribing.org)", u:"https://deprescribing.org/wp-content/uploads/2025/10/Statin-Deprescribing-Algorithm.pdf", w:"One-page algorithm: who to have the conversation with, what prompts it, and what to do after stopping.", t:"Background"},
    {n:"A guide to deprescribing statins (PHN Tasmania)", u:"https://assets.primaryhealthtas.com.au/uploads/2018/09/A-Guide-to-Deprescribing-Statins.pdf", w:"Carries the numbers needed to treat for primary versus secondary prevention, and the minimum-dose-first strategy.", t:"Background"},
    {n:"Algorithm for managing statin intolerance (GPnotebook AU)", u:"https://gpnotebook.com/en-AU/pages/cardiovascular-medicine/algorithm-for-the-management-of-statin-intolerance", w:"Statin intolerance pathway to guide assessment before anyone is labelled intolerant.", t:"Background"},
    {n:"Cholesterol Treatment Trialists — statins and side effects", u:"https://www.cttcollaboration.org/news-1/statins-side-effects", w:"The CTT position that statins do not cause the majority of side effects listed in package leaflets.", t:"Background"},
    {n:"FH Australia", u:"https://fhaustralia.org.au/", w:"Diagnosis, treatment targets, cascade testing and Lp(a). Has a find-a-clinician directory, which is what turns a suspicion into a referral.", t:"AU guideline"},
    {n:"FH Australia — about Lp(a)", u:"https://fhaustralia.org.au/about-lpa/", w:"Lp(a) is genetically determined, stable through life, not on a routine lipid panel, and affects roughly 1 in 5 people.", t:"AU guideline"},
    {n:"Managing hypercholesterolaemia — Australian Prescriber 2024", u:"https://australianprescriber.tg.org.au/articles/managing-hypercholesterolaemia.html", w:"Nelson AJ, Nicholls SJ. Aust Prescr 2024;47:7-14. The source the course cites for fasting versus non-fasting sampling and testing frequency.", t:"AU guideline"},
    {n:"ESC/EAS 2019 dyslipidaemia guidelines (PubMed)", u:"https://pubmed.ncbi.nlm.nih.gov/31504418/", w:"European guideline with a very-high-risk category the AusCVDRisk calculator does not have. European calculator, European bands — read it for the concept, not for Australian thresholds.", t:"Background"}
  ]},
