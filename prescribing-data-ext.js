...
var LINKS = [
  ...
  {id:"bgl", name:"Blood glucose and type 2 diabetes", blurb:"The ADS algorithm is the escalation map. The QLD protocol is the scope boundary. They answer different questions — do not substitute one for the other.", items:[
    ...
    {n:"QLD pilot — blood glucose management protocol (PDF)", u:"https://www.health.qld.gov.au/__data/assets/pdf_file/0013/1451101/cvd-bloodglucose-protocol.pdf", w:"Required reading for Week 3. Eligibility, exclusions, what you may prescribe and monitoring for the Blood Glucose Management Program.", t:"Governs practice"},
